			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="left">
					<ul>
						...
						<li><a href="tel:<?php echo $contact_phone; ?>"><i class="fa fa-phone"></i> <span><?php echo $contact_phone; ?></span></a></li>
						<li><a href="mailto:<?php echo $contact_email; ?>"><i class="fa fa-envelope-o"></i> <span><?php echo $contact_email; ?></span></a></li>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
