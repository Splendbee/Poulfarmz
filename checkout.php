                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        if($total) {
                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                            foreach ($result as $row) {
                                $quantity = array_sum($_SESSION['cart_p_qty']);
                                $gross_shipping_cost = $row['amount']*$quantity; // Gives Total Amount of Delivering all items 
                                if ($quantity === 1) {
                                    $discount = 0;
                                }
                                else {
                                    $discount = (1/$quantity)*$gross_shipping_cost*0.40; // Percentage Reduces with more items (Returns Amount Discounted)
                                }
                                echo $discount;
                                $shipping_cost = $gross_shipping_cost - $discount; 
                            }
                        } else {
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
				                <div style="color:red;font-size:22px;margin-bottom:50px;">
			                        You must have to fill up all the billing and shipping information from your dashboard panel in order to checkout the order. <b>NOTE: SHIPPING ADDRESS is the address to be delivered to!</b> Please fill up the information going to <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">this link</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        ...
	                                        <option value="Bank Deposit"><?php echo LANG_VALUE_38; ?> / Transfer</option>
	                                    </select>
	                                </div>
